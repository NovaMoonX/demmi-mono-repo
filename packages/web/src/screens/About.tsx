    ...
    <div className='page flex flex-col items-center overflow-y-auto'>
      <div className='w-full max-w-4xl px-6 py-16 md:py-24 space-y-16'>
        ...
        <section className='space-y-4'>
          ...
          <p className='text-lg text-foreground/80 leading-relaxed'>
            The AI was smart, but it was blind. It couldn't see my kitchen inventory. It didn't know what meals I'd already saved. It had no idea what I'd asked about last week. Every conversation started from zero, forcing me to re-explain context that should have been obvious.
          </p>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <div className='space-y-4'>
            <p className='text-lg text-foreground/80 leading-relaxed'>
              Modern AI tools like ChatGPT operate in distinct, isolated threads. You ask about chicken recipes in one conversation. You discuss meal prep strategies in another. You request ingredient substitutions in a third. None of these conversations talk to each other.
            </p>
            <p className='text-lg text-foreground/80 leading-relaxed'>
              But cooking isn't isolated. It's interconnected. The chicken you bought yesterday affects what you can make today. The meal prep conversation influences your shopping list. The ingredient substitution discussion should update your saved recipes.
            </p>
            <p className='text-lg text-foreground/80 leading-relaxed'>
        ...
        <section className='space-y-6'>
          ...
          <div className='space-y-4'>
            ...
            <p className='text-lg text-foreground/80 leading-relaxed'>
              Your ingredient inventory lives in the system. When you ask "What can I make for dinner?" the AI sees what you actually have—chicken breast, broccoli, rice, whatever's in your fridge. It suggests meals from your saved collection that you can make right now, not theoretical recipes that require a shopping trip.
            </p>
            <p className='text-lg text-foreground/80 leading-relaxed'>
              Your meal library is connected. When the AI recommends something, it can pull from recipes you've already created or saved. It knows which meals you've planned for the week. It understands your cooking patterns because it has access to your calendar and meal history.
            </p>
            <p className='text-lg text-foreground/80 leading-relaxed'>
              Pricing and nutrition aren't estimates—they're calculations. Each ingredient has real cost data and nutrient profiles. When you plan a meal, Demmi calculates exactly how much it costs and what macros it provides. When you need to shop, it generates a list with quantities and pricing already figured out.
            </p>
            <p className='text-lg text-foreground/80 leading-relaxed'>
        ...
        <section className='space-y-6'>
          ...
          <div className='space-y-4'>
            ...
            <p className='text-lg text-foreground/80 leading-relaxed'>
              This matters for two reasons: privacy and control. Your meal plans, ingredient inventory, dietary preferences, and spending patterns stay on your device. Period. No company is building a profile of what you eat. No algorithm is learning from your kitchen to sell you supplements or meal kits.
            </p>
            <p className='text-lg text-foreground/80 leading-relaxed'>
            ...
            <table className='w-full border-collapse'>
              ...
              <tbody>
                <tr className='border-b border-foreground/10'>
                  ...
                  <td className='text-center py-4 px-4 text-foreground/70'>Unified context connected to your ingredients, meals, and plans</td>
                </tr>
                <tr className='border-b border-foreground/10'>
                ...
                <tr className='border-b border-foreground/10'>
                  ...
                  <td className='text-center py-4 px-4 text-foreground/70'>Everything connected—ingredients, meals, calendar, shopping, nutrition</td>
                </tr>
              </tbody>
            </table>
          </div>
